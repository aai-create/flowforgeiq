...
export const ListMessagesResponseItem = zod.object({
  ...
  "reviewStatus": zod.string().optional().describe('not_required | pending | confirmed | corrected | dismissed | deferred | error'),
  "reviewDecision": zod.record(zod.string(), zod.unknown()).nullish().describe('Structured category, confidence, reason, and evidence for the pending decision'),
  "reviewAudit": zod.array(zod.record(zod.string(), zod.unknown())).optional().describe('Append-only history of review actions')
})
...
export const reviewSignalBodyNoteMax = 2000;



export const ReviewSignalBody = zod.object({
  "action": zod.enum(['confirm', 'correct', 'dismiss', 'defer']),
  "shipmentId": zod.number().optional().describe('Required for a correction; optional for confirming an AI shipment match'),
  "note": zod.string().max(reviewSignalBodyNoteMax).optional()
})

export const reviewSignalResponseDirectionDefault = `inbound`;
...
export const ReviewSignalResponse = zod.object({
  ...
  "channel": zod.string(),
  "subject": zod.string().nullish().describe('Subject line for outbound email messages'),
  "direction": zod.enum(['inbound', 'outbound']).default(reviewSignalResponseDirectionDefault),
  "snippet": zod.string(),
  "fullBody": zod.string(),
  "aiDraft": zod.string(),
  "aiAction": zod.string(),

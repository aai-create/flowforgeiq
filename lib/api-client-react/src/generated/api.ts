...
export const getReviewSignalUrl = (messageId: number,) => {




  return `/api/signal-inbox/${messageId}/review`
}

/**
 * @summary Confirm, correct, dismiss, or defer an uncertain routing or extraction decision
 */
export const reviewSignal = async (messageId: number,
    signalReviewInput: SignalReviewInput, options?: RequestInit): Promise<Message> => {

  return customFetch<Message>(getReviewSignalUrl(messageId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getReviewSignalMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof reviewSignal>>, TError,{messageId: number;data: BodyType<SignalReviewInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof reviewSignal>>, TError,{messageId: number;data: BodyType<SignalReviewInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof reviewSignal>>, {messageId: number;data: BodyType<SignalReviewInput>}> = (props) => {
          const {messageId,data} = props ?? {};

          return  reviewSignal(messageId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ReviewSignalMutationError = ErrorType<void>

    /**
 * @summary Confirm, correct, dismiss, or defer an uncertain routing or extraction decision
 */
export const useReviewSignal = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof reviewSignal>>, TError,{messageId: number;data: BodyType<SignalReviewInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof reviewSignal>>,
        TError,
        {messageId: number;data: BodyType<SignalReviewInput>},
        TContext
      > => {

...
export interface UiPayment { label: string; percent: number; amountUsd: number; paid: boolean; dueDate: string; paymentId: number; paidAt: string | null; paidMethod: string | null; intermediaryAdvanceUsd: number | null; intermediaryRecoveredUsd: number | null; }

...
export default function SignInScreen() {
  ...
  const setActive = clerkSignIn?.setActive ?? clerk?.setActive;
      ...
      <View style={[styles.root, { backgroundColor: c.background, paddingTop: insets.top + (Platform.OS === "web" ? 67 : 0) }]}>
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.kav}>
          <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
            ...
            <Text style={[styles.title, { color: c.foreground }]}>Verify your identity</Text>
            ...
            <Pressable onPress={() => { setNeedsMfa(false); setVerifyCode(""); setError(null); }} style={styles.secondaryBtn}>
              <Text style={[styles.secondaryBtnText, { color: c.primary }]}>Go back</Text>
            </Pressable>
          </ScrollView>
        </KeyboardAvoidingView>
      </View>
    ...
    <View style={[styles.root, { backgroundColor: c.background, paddingTop: insets.top + (Platform.OS === "web" ? 67 : 0) }]}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.kav}>
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <Text style={[styles.subtitle, { color: c.mutedForeground }]}>
            Sign in to your supply-chain inbox
          </Text>
          ...
          <View style={styles.linkRow}>
            <Text style={[styles.linkText, { color: c.mutedForeground }]}>Don't have an account? </Text>
            <Link href={"/(auth)/sign-up" as any}>
              <Text style={[styles.linkAction, { color: c.primary }]}>Sign up</Text>
            </Link>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  googleBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, borderWidth: 1.5, borderRadius: 12, paddingVertical: 14, marginBottom: 20 },
